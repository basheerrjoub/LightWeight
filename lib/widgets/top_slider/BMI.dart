...
class _DetailPageState extends State<BMI> {
  ...
  Widget build(BuildContext context) {
    double bmiValue = calculateBMI(user.weight, user.height/100);
                  ...
                  child: Column(
                    children: [
                      ...
                      Card(
                        ...
                        margin: EdgeInsets.symmetric(horizontal: 25.w, vertical: 20.h), // Margin for positioning
                        child: Padding(
                          padding: EdgeInsets.all(15.w), // Internal padding
                          child: Column(
                            children: [
                              Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  ...
                                  Icon(Icons.privacy_tip_rounded, size: 28.w,color: Color(0xff3a0400)),
                                  Text(
                                    "Advice",
                                    style: TextStyle(
                                        color: Color(0xff3a0400), // Card is typically light, so text can be dark
                                        fontSize: 22.w,
                                        fontWeight: FontWeight.bold
                                    ),
                                  ),
                              ...
                              Text(
                                ...
                                style: TextStyle(
                                    color: Color(0xff121421), // Adjusting for better readability
                                    fontSize: 16.w,
